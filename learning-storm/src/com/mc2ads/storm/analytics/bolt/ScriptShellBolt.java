package com.mc2ads.storm.analytics.bolt;
...
import com.mc2ads.storm.analytics.utils.CustomShellProcess;
 ...
 *
 * <pre>
 * public class MyBolt extends ScriptShellBolt implements IRichBolt {
 *      public MyBolt() {
 ...
 * </pre>
 */
public class ScriptShellBolt implements IBolt {
    public static Logger LOG = Logger.getLogger(ScriptShellBolt.class);
    Process _subprocess;
    ...
    public ScriptShellBolt(ShellComponent component) {
        this(component.get_execution_command(), component.get_script());
    }

    public ScriptShellBolt(String... command) {
        _command = command;
    }
